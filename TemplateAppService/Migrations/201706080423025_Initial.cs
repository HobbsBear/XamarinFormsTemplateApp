namespace TemplateAppService.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Location = c.String(),
                        MaxNumberOfAttendees = c.Int(),
                        MinNumberOfAttendees = c.Int(nullable: false),
                        EventCompetitionLevel = c.Int(nullable: false),
                        ...
                        EventStatus_Id = c.String(maxLength: 128),
                        EventType_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.EventStatus", t => t.EventStatus_Id)
                .ForeignKey("dbo.EventTypes", t => t.EventType_Id)
                .ForeignKey("dbo.Users", t => t.HostUserID, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        Name = c.String(),
                        DefaultMaxAttendees = c.Int(),
                        DefaultMinAttendees = c.Int(nullable: false),
                        Version = c.Binary(nullable: false, fixedLength: true, timestamp: true, storeType: "rowversion",
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
        ...
        {
            DropForeignKey("dbo.Events", "HostUserID", "dbo.Users");
            ...
            DropIndex("dbo.EventTypes", new[] { "CreatedAt" });
            DropIndex("dbo.EventStatus", new[] { "CreatedAt" });
            DropIndex("dbo.Events", new[] { "EventType_Id" });
            DropIndex("dbo.Events", new[] { "EventStatus_Id" });
            DropIndex("dbo.Events", new[] { "CreatedAt" });
            DropIndex("dbo.Events", new[] { "HostUserID" });
            ...
            DropTable("dbo.RegisteredEvents");
